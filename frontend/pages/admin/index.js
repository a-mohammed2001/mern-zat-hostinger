    ...
    const blogsList = blogs.map((blog,i)=>{
        return(
            ...
            <div className="">          
                ...
                <button className="bg-blue-500 text-white border-none my-1 w-full border rounded p-2" onClick={()=>{
                    updateBlog(blog,blog._id,blog.title,blog.author,blog.date,blog.paragraphs)
                    }}>done</button>
                </div>  
                </Fragment>
                } 
